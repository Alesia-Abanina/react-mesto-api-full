    ...
    <main className="content">
      <section className="auth">
        <div className="auth__container">
          ...
          <form className="form auth__form" name={`form_signin`} onSubmit={handleSubmit} noValidate>
            <fieldset className="form__input-container auth__fieldset">
              ...
              <div className="auth__confirmation">
                <button type="submit" className="auth__button button form__submit">Войти</button>
                <div className="auth__dummy"></div>
              </div>
            </fieldset>
          </form>
        </div>
